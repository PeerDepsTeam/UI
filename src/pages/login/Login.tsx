...
const Login: FC = () => (
  <div className="h-screen flex justify-center items-center" style={{
    ...
    <div className="w-[30%] mx-auto" style={{
      marginLeft:"15%",
    }}>
      <Card className="w-full h-full border-none shadow-none">
        <h1 className="ml-4 font-bold text-purple-300 text-6xl">EDUC-FI .</h1>
        <br/>
        <hr className="text-purple-300 w-16 ml-5" />
        <CardHeader>
        ...
        <CardContent style={{ width: "500px" }}>
          <div className="flex justify-between mt-4">
            <Button
              variant="outline"
              className="bg-purple-300 text-white border-purple-100"
            >
              <svg
