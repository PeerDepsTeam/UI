...
export const Home: FC = () => {
  return (
    <>
      <div
        className="h-full h-screen w-full bg-cover bg-center object-cover pt-1 brightness-75 filter filter"
        ...
        <div className="mt-5 h-screen">
          ...
          <div className="flex h-screen items-center justify-center">
            <div className="w-1/3 ">
              ...
              <p className="w-{30px} text-l mt-6 text-center text-2xl text-white">
              ...
              <div className="flex items-center justify-center ">
                <Button className="text-md mt-12 rounded-full bg-[#FC4F00] px-12 py-7  hover:bg-[#FC4F00]">
